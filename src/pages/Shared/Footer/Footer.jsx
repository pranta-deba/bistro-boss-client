    ...
    return (
        <div className="text-white">
            <div className="flex flex-col md:flex-row">
                <div className="flex-1 flex flex-col justify-center items-center gap-3 bg-[#1F2937] py-24">
                    <h4 className="text-3xl font-medium">CONTACT US</h4>
                    <p className="text-xl font-medium text-center">123 ABS Street, <br /> Uni 21, Bangladesh</p>
                    <p>+88 123456789</p>
                    <p>Mon - Fri: 08:00 - 22:00</p>
                    <p>Sat - Sun: 10:00 - 23:00</p>
                </div>
                <div className="flex-1 flex flex-col justify-center items-center gap-3 bg-[#111827] py-24">
            ...
            <div className="text-center bg-[#151515] px-3 py-4">
