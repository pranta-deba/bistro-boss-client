    ...
    return (
        <div className="mx-4">
            ...
            <div className="flex flex-col md:flex-row">
                <h1 className="text-3xl font-bold cinzelFont">Total Users: {users.length}</h1>
            </div>
            <div>
                                ...
                                users.map((user, idx) => (
                                    <tr key={user._id}>
                                        ...
                                        <td>
                                            {
                                                user?.role === "admin" ?
                                                    <button className="btn bg-[#D1A054]">Admin</button>
                                                    :
                                        ...
                                        <th>
                                            <button onClick={() => handleDelete(user._id)} className="btn bg-[#B91C1C]">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
