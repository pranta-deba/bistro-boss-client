...
const Contact = () => {
    return (
        <div className="mb-12">
            ...
            <div>
                <Cover img={cover} title={"CONTACT US"} sortDes={"Would you like to try a dish?"} />
            ...
            <div className="md:w-[60%] mx-auto bg-[#F3F3F3] p-12">
                <form onSubmit={(e) => {
                    ...
                    <div>
                        ...
                        <input className="w-full input rounded-none outline-none" type="text" name="name" id="name" placeholder="Enter your name" />
                    </div>
                    <div>
                        <label className="text-xl font-semibold mb-2">Email*</label> <br />
                        <input className="w-full input rounded-none outline-none" type="email" name="name" id="email" placeholder="Enter your email" />
                    </div>
                    <div className="md:col-span-2">
                        <label className="text-xl font-semibold mb-2">Phone*</label> <br />
                        <input className="w-full input rounded-none outline-none" type="number" name="name" id="phone" placeholder="Enter your phone number" />
                    </div>
                    <div className="md:col-span-2">
                        <label className="text-xl font-semibold mb-2">Message*</label> <br />
                        <textarea className="w-full input rounded-none outline-none h-[100px] md:h-[200px]" name="name" id="message" placeholder="Write your message here"></textarea>
                    </div>
                    <div className="flex justify-center md:col-span-2">
                        <button type="submit" className="bg-gradient-to-r from-[#835D23] to-[#B58130] flex btn text-white"><span>Send Message</span><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
